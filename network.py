...
#declaring the shape and size of the neural network
input_nodes = 784
hidden_nodes = 100
output_nodes = 10
...
test_data_file = open("Desktop/mnist_dataset/mnist_test.csv", 'r') #open the testing file
...
for record in test_data_list: #sets the range of the dataset
    ...
    correct_label = int(all_values[0]) #finds the target answer, then prints it
